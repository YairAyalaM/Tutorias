        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full sm:h-auto h-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form>
                <div class="text-right text-2xl mb-2 m-4">
                    <i class="fa-solid fa-xmark cursor-pointer" wire:click="cerrarModalLesson()" wire:loading.remove wire:target="cerrarModalLesson"></i>
                    <svg style="display: none" disabled wire:loading wire:target="cerrarModalLesson" role="status" class="inline w-6 h-6 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
